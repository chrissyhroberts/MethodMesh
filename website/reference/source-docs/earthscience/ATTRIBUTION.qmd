---
title: "Attribution and external design references"
subtitle: "Module source document · Earth science utilities"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/earthscience/docs/ATTRIBUTION.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
