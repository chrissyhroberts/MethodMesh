---
title: "Dice Simulator engine regression vectors"
subtitle: "Module source document · Chance"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/chance/docs/DICE_ENGINE_TEST_VECTORS.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
