...
::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/chance/docs/README_WeightedChoice.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
