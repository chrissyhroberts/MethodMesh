---
title: "Chance roadmap note"
subtitle: "Module source document · Chance"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/chance/docs/ROADMAP_NOTE.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
