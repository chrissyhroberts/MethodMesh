---
title: "ESP32 sensor framework installer"
subtitle: "Module source document · ESP32 sensor framework"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/sensorfirmwareinstaller/docs/README_SensorFirmwareInstaller.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
