...
subtitle: "Module source document · Calibrated scale"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/calibratedscale/docs/README_CalibratedScale.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
