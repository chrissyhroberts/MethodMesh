---
title: "Cryptography capability"
subtitle: "Module source document · Cryptography"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/cryptography/docs/README_Cryptography.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
