---
title: "Clinical Instruments core library expansion v0.2"
subtitle: "Module source document · Clinical Instruments"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/clinicalinstruments/docs/CORE_LIBRARY_EXPANSION_v0.2.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
