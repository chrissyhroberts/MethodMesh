---
title: "Sound generator — drop-in installation"
subtitle: "Module source document · Sound generator"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/soundgenerator/docs/DROP_IN.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
