...
::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/time_tools/docs/INTEGRATION_NOTES.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
