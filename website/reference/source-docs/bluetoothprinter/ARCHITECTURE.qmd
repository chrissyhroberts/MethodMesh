---
title: "Standalone capability architecture"
subtitle: "Module source document · Bluetooth printer"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/bluetoothprinter/docs/ARCHITECTURE.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
