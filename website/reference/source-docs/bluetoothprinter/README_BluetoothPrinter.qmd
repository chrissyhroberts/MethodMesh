---
title: "Bluetooth printer module — Qutie family"
subtitle: "Module source document · Bluetooth printer"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/bluetoothprinter/docs/README_BluetoothPrinter.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
