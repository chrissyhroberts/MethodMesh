---
title: "Protocol provenance and attribution"
subtitle: "Module source document · Bluetooth printer"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/bluetoothprinter/docs/ATTRIBUTION.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
