---
title: "MethodMesh Acoustics capability"
subtitle: "Module source document · Acoustics"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/acoustics/docs/README_Acoustics.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
