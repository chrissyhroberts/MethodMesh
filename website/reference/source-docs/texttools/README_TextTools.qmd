---
title: "MethodMesh Text Tools"
subtitle: "Module source document · Text tools"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/texttools/docs/README_TextTools.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
