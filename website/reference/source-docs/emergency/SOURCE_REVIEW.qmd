---
title: "Emergency source review ledger — Development"
subtitle: "Module source document · Emergency"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/emergency/docs/SOURCE_REVIEW.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
