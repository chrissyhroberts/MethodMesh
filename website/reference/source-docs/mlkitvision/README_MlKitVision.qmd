---
title: "ML Kit vision"
subtitle: "Module source document · ML Kit vision"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/mlkitvision/docs/README_MlKitVision.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
