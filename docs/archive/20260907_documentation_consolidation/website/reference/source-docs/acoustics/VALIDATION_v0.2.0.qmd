---
title: "Acoustics v0.2.0 validation note"
subtitle: "Module source document · Acoustics"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/acoustics/docs/VALIDATION_v0.2.0.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
