---
title: "Scaled photo selector capability"
subtitle: "Module source document · Image annotation and redaction"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/scaledphoto/docs/README_ScaledPhoto.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
