...
::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/tabletoputilities/docs/README_TabletopUtilities.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
