---
title: "Tabletop Utilities state-engine regression vectors"
subtitle: "Module source document · Tabletop utilities"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/tabletoputilities/docs/STATE_ENGINE_TEST_VECTORS.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
