---
title: "Runtime fix — v0.1.2"
subtitle: "Module source document · Tabletop utilities"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/tabletoputilities/docs/RUNTIME_FIX_v0.1.2.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
