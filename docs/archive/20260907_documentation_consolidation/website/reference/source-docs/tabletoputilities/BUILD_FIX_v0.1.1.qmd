---
title: "Tabletop Utilities v0.1.1 build-fix note"
subtitle: "Module source document · Tabletop utilities"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/tabletoputilities/docs/BUILD_FIX_v0.1.1.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
