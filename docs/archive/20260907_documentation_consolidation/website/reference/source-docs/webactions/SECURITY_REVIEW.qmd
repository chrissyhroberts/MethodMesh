---
title: "Web Actions v0.10 security review"
subtitle: "Module source document · Web Actions"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/webactions/docs/SECURITY_REVIEW.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
