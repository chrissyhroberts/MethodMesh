---
title: "SVG polygon selector capability"
subtitle: "Module source document · SVG polygon selector"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/svgselector/docs/README_SvgSelector.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
