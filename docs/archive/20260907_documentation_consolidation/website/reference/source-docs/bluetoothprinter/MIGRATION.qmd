---
title: "Migration to v2.12"
subtitle: "Module source document · Bluetooth printer"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/bluetoothprinter/docs/MIGRATION.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
