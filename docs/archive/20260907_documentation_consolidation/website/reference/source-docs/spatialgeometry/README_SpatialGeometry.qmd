...
subtitle: "Module source document · Spatial geometry"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/spatialgeometry/docs/README_SpatialGeometry.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
