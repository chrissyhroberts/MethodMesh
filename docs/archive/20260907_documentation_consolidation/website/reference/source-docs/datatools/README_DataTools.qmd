...
::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/datatools/docs/README_DataTools.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
