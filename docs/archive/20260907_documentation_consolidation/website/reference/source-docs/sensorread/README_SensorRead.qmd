---
title: "Read sensor"
subtitle: "Module source document · ESP32 sensor framework"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/sensorread/docs/README_SensorRead.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
