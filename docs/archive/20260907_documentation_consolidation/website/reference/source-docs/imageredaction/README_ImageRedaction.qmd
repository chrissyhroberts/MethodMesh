...
::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/imageredaction/docs/README_ImageRedaction.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
