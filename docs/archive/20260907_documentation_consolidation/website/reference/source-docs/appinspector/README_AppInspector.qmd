...
subtitle: "Module source document · Android app inspector"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/appinspector/docs/README_AppInspector.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
