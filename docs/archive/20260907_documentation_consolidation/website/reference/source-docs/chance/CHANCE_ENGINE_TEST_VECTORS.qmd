---
title: "Chance selection engine regression notes"
subtitle: "Module source document · Chance"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/chance/docs/CHANCE_ENGINE_TEST_VECTORS.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
