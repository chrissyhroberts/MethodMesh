...
::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/clinicalinstruments/docs/ROADMAP_NOTE.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
