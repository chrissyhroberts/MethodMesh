---
title: "Future protocol engine — relevance, constraints and WHO Verbal Autopsy"
subtitle: "Module source document · Clinical Instruments"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/clinicalinstruments/docs/FUTURE_PROTOCOL_ENGINE.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
