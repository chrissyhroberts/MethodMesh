---
title: "Clinical Instruments v0.1.1 launch-crash patch"
subtitle: "Module source document · Clinical Instruments"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/clinicalinstruments/docs/PATCH_0.1.1.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
