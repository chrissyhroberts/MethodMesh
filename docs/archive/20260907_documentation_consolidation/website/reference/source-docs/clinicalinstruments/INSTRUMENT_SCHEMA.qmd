---
title: "Clinical Instruments constrained YAML schema — v0.1"
subtitle: "Module source document · Clinical Instruments"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/clinicalinstruments/docs/INSTRUMENT_SCHEMA.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
