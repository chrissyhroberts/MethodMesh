...
subtitle: "Module source document · Conversation translator"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/conversationtranslate/docs/README_ConversationTranslate.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
