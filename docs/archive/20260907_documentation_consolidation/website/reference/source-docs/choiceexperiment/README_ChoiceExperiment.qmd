...
subtitle: "Module source document · Discrete choice experiments"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/choiceexperiment/docs/README_ChoiceExperiment.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
