...
subtitle: "Module source document · External command library"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/providercommands/docs/README_ProviderCommand.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
