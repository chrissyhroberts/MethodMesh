...
::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/qrcode/docs/README_QrCode.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
