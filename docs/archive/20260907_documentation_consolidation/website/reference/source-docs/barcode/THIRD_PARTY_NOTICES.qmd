...
::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/qrcode/docs/THIRD_PARTY_NOTICES.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
