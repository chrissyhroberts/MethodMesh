...
subtitle: "Module source document · Bluetooth device inspector"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/bluetoothinspector/docs/README_BluetoothInspector.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
