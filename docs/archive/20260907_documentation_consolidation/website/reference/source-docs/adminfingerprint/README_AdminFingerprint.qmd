...
subtitle: "Module source document · Local device authentication"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/adminfingerprint/docs/README_AdminFingerprint.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
