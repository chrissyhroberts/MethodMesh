...
subtitle: "Module source document · Document scanner"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/documentscanner/docs/README_DocumentScanner.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
