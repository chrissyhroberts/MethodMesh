...
::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/networktools/docs/README_NetworkTools.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
