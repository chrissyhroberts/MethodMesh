---
title: "Provision BLE sensor node"
subtitle: "Module source document · ESP32 sensor framework"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/sensorprovisioner/docs/README_SensorProvisioner.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
