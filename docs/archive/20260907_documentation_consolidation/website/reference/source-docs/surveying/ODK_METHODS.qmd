---
title: "Surveying ODK / XLSForm intent catalogue"
subtitle: "Module source document · Surveying"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/surveying/docs/ODK_METHODS.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
