---
title: "Repository roadmap note — Psychomotor vigilance test v0.1.0"
subtitle: "Module source document · Psychomotor vigilance test (PVT)"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/psychomotorvigilance/docs/ROADMAP_NOTE.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
