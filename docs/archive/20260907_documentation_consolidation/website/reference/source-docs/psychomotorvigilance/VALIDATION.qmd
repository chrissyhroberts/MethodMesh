---
title: "Validation record — module handoff"
subtitle: "Module source document · Psychomotor vigilance test (PVT)"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/psychomotorvigilance/docs/VALIDATION.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
