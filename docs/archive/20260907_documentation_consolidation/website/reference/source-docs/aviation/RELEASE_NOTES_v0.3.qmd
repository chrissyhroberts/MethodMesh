---
title: "Aviation v0.3 — emergency reference panel"
subtitle: "Module source document · Aviation tools"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/aviation/docs/RELEASE_NOTES_v0.3.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
