---
title: "Expenses"
subtitle: "Module source document · Expenses"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/expenses/docs/README_Expenses.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
