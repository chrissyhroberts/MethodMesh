---
title: "Roadmap note — Multi-counter"
subtitle: "Module source document · Multi-counter"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/multicounter/docs/ROADMAP_NOTE.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
