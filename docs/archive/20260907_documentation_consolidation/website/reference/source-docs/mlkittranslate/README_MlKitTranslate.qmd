...
subtitle: "Module source document · ML Kit translation"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/mlkittranslate/docs/README_MlKitTranslate.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
