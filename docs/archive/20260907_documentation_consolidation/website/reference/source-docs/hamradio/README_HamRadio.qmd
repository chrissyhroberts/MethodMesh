...
::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/hamradio/docs/README_HamRadio.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
