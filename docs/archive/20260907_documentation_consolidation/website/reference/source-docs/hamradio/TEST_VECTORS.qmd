---
title: "Ham Radio v0.4.0 — deterministic test vectors"
subtitle: "Module source document · Amateur radio"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/hamradio/docs/TEST_VECTORS.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
