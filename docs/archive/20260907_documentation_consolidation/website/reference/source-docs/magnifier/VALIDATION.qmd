---
title: "Magnifier validation"
subtitle: "Module source document · Magnifier"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/magnifier/docs/VALIDATION.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
