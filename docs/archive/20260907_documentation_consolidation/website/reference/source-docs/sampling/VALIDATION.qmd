---
title: "Sampling drop-in validation"
subtitle: "Module source document · Sampling"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/sampling/docs/VALIDATION.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
