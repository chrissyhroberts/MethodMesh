---
title: "Capability-guide alignment — Sampling v0.1.1"
subtitle: "Module source document · Sampling"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/sampling/docs/ALIGNMENT_CAPABILITY_GUIDE_2026-09-03.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
