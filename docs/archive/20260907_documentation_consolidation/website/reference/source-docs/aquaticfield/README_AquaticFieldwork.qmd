---
title: "Aquatic Fieldwork — MethodMesh module"
subtitle: "Module source document · Aquatic fieldwork"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/aquaticfield/docs/README_AquaticFieldwork.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
