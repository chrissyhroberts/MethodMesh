---
title: "MethodMesh Aquatic Fieldwork Capability Package"
subtitle: "Module source document · Aquatic fieldwork"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/aquaticfield/docs/AQUATIC_FIELDWORK_SPEC.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
