...
subtitle: "Module source document · Plus Code capture"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/pluscodecapture/docs/README_PlusCodeCapture.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
