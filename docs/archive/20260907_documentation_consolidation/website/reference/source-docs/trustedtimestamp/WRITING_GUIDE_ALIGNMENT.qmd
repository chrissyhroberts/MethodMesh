---
title: "Writing-guide alignment"
subtitle: "Module source document · Trusted timestamp"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/trustedtimestamp/docs/WRITING_GUIDE_ALIGNMENT.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
