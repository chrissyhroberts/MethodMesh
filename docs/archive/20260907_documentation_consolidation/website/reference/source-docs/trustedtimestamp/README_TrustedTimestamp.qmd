...
::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/trustedtimestamp/docs/README_TrustedTimestamp.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
