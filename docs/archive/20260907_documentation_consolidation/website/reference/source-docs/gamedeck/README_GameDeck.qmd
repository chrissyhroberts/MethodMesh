---
title: "GameDeck v0.058"
subtitle: "Module source document · GameDeck"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/gamedeck/docs/README_GameDeck.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
