...
::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/earthscience/docs/README_EarthScience.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
