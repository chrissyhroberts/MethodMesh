---
title: "Earth Science v0.1.1"
subtitle: "Module source document · Earth science utilities"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/earthscience/docs/CHANGELOG_v0.1.1.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
