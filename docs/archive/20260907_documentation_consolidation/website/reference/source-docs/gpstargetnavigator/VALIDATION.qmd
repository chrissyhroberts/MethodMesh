---
title: "GPS target navigator — v1.05 validation"
subtitle: "Module source document · GPS target navigator"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/gpstargetnavigator/docs/VALIDATION.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
