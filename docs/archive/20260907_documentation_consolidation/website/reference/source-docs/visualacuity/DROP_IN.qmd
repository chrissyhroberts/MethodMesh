---
title: "Visual acuity drop-in installation"
subtitle: "Module source document · Visual acuity"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/visualacuity/docs/DROP_IN.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
