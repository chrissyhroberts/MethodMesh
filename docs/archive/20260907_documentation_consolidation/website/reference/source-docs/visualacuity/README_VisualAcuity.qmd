...
::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/visualacuity/docs/README_VisualAcuity.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
