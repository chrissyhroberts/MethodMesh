---
title: "Reference Library architecture — v0.2.6"
subtitle: "Module source document · Reference library"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/referencelibrary/docs/ARCHITECTURE.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
