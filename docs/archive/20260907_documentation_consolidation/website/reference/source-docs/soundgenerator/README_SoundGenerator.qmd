...
::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/soundgenerator/docs/README_SoundGenerator.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
