---
title: "Field Statistics v0.1.0 — reference test vectors"
subtitle: "Module source document · Field Statistics"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/fieldstats/docs/TEST_VECTORS.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
