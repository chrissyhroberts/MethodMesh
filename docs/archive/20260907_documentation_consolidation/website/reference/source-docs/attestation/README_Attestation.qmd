...
subtitle: "Module source document · Traceable attestation"
search: true
---

::: {.callout-note}
**Source-local reference.** This document is preserved from `modules/attestation/docs/README_Attestation.md` in the supplied source snapshot. The Master Book remains authoritative for cross-cutting architecture.
:::
