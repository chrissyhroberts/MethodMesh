...
class ChoiceOdkFormContractTest {
    @Test
    fun `choice forms carry lists as group extras instead of intent expressions`() {
        val docs = listOf(
        ...
        val methodByWorkbook = mapOf(
            "example_odk_ChoicePairwise.xlsx" to "dce.pairwise",
            "example_odk_ChoiceMaxDiff.xlsx" to "dce.maxdiff",
            "example_odk_ChoiceRanking.xlsx" to "dce.ranking",
            "example_odk_ChoicePoints.xlsx" to "dce.points",
            "example_odk_ChoiceConjoint.xlsx" to "dce.conjoint"
        )
        ...
        workbooks.forEach { (workbook, methodId) ->
            ...
            assertTrue(
                ...
                "com.example.researchos.EXECUTE_METHOD(method_id='$methodId',return_mode='flat')" in xml
            )
