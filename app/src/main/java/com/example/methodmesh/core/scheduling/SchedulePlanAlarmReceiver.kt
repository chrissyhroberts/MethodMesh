...
class SchedulePlanAlarmReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val open = Intent(context, SchedulePlanDispatchActivity::class.java)
            ...
            .putExtra("occurrence_id", occurrence.id)
        ...
        if (android.os.Build.VERSION.SDK_INT >= 26) {
            val channel = NotificationChannel(
                CHANNEL,
                "MethodMesh scheduled reminders",
                NotificationManager.IMPORTANCE_HIGH
            ).apply {
                description = "Time-sensitive MethodMesh schedule reminders"
    ...
    companion object { const val ACTION = "com.example.methodmesh.SCHEDULE_PLAN_ALARM"; const val ACTION_DONE = "com.example.methodmesh.SCHEDULE_PLAN_DONE"; const val ACTION_SNOOZE = "com.example.methodmesh.SCHEDULE_PLAN_SNOOZE"; const val CHANNEL = "methodmesh_schedule_plans_v2" }
}
