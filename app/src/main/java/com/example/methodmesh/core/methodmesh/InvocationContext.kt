...
/**
 * Context supplied by a caller such as ODK when it asks MethodMesh to do work.
 *
 * The caller usually owns the current form state; MethodMesh owns execution and
