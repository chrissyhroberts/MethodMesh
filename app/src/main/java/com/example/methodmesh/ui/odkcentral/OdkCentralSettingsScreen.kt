...
fun OdkCentralSettingsScreen() {
    ...
    Column(Modifier.fillMaxWidth()) {
        ...
        if (profile.projectId != null) {
            ...
            Text(
                "Ticking a form in the ODK Forms library deploys or updates it, publishes it, and grants this App User access. Unticking revokes only this user's access; it does not delete submissions or the remote form.",
