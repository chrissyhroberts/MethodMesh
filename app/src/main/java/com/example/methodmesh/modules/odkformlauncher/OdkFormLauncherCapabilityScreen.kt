            ...
            IntentExampleDropdown(
                ...
                examples = listOf(
                    IntentExample(
                        ...
                        intentUri = "com.example.methodmesh.EXECUTE_METHOD(method_id='odk_form_launcher',input_project_id='my_project_id',input_form_selector='my_form_id',return_mode='flat')"
                    )
                )
            )
        }
