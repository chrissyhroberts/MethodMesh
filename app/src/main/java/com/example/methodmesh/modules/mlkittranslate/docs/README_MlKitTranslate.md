...
```text
com.example.methodmesh.EXECUTE_METHOD(method_id='mlkit.translate',input_source_language='en',input_target_language='fr',input_text='hello world',return_mode='flat')
```

List downloaded language models:

```text
com.example.methodmesh.EXECUTE_METHOD(method_id='mlkit.translate',input_model_action='list',return_mode='flat')
```

Download a language model:

```text
com.example.methodmesh.EXECUTE_METHOD(method_id='mlkit.translate',input_model_action='download',input_model_language='fr',return_mode='flat')
```
