...
data class SensorFirmwareInstallOutcome(
    ...
    val firmwareVersion: String = "methodmesh-sensor-0.1.1",
...
object As100SensorFirmwareInstallerMethod : As100Method {
    ...
    override val id = ID
    override val ref = ArchitectureRef(ArchitectureId(ID), "Method", "Install MethodMesh ESP32 sensor firmware")
    override val descriptor = MethodDescriptor(
        id = ArchitectureId(ID), methodType = MethodObjectType.Workflow,
        name = "Install ESP32 sensor firmware", version = VERSION,
        description = "Install the bundled MethodMesh MicroPython sensor firmware to an ESP32-C3 over USB.",
