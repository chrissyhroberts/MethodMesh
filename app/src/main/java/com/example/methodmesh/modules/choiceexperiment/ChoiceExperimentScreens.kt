    ...
    private fun getMethodExamples(method: DceMethod): List<IntentExample> = when (method) {
        DceMethod.Pairwise -> listOf(
            IntentExample(
                ...
                intentUri = "com.example.methodmesh.EXECUTE_METHOD(method_id='dce.pairwise',input64_items='T3B0aW9uIEF8T3B0aW9uIEJ8T3B0aW9uIEM',input_rounds='3')"
            ),
            IntentExample(
                label = "With seed",
                description = "Reproducible design using a seed",
                intentUri = "com.example.methodmesh.EXECUTE_METHOD(method_id='dce.pairwise',input64_options='U3BlZWR8Q29zdHxTYWZldHk',input_rounds='4',input_seed='study_001')"
            )
        )
        DceMethod.MaxDiff -> listOf(
            IntentExample(
                ...
                intentUri = "com.example.methodmesh.EXECUTE_METHOD(method_id='dce.maxdiff',input64_items='U3BlZWR8Q29zdHxTYWZldHl8Q29tZm9ydA',input_rounds='4')"
            ),
            IntentExample(
                label = "4 items per round",
                description = "Show 4 items in each round",
                intentUri = "com.example.methodmesh.EXECUTE_METHOD(method_id='dce.maxdiff',input64_options='UXVhbGl0eXxQcmljZXxTZXJ2aWNlfFNlbGVjdGlvbg',input_rounds='5',input_items_per_round='4')"
            )
        )
        DceMethod.Ranking -> listOf(
            IntentExample(
                ...
                intentUri = "com.example.methodmesh.EXECUTE_METHOD(method_id='dce.ranking',input64_items='Rmlyc3R8U2Vjb25kfFRoaXJkfEZvdXJ0aA',input_rounds='3')"
            ),
            IntentExample(
                label = "Top-k ranking",
                description = "Rank only top 3 options",
                intentUri = "com.example.methodmesh.EXECUTE_METHOD(method_id='dce.ranking',input64_options='T3B0aW9uMXxPcHRpb24yfE9wdGlvbjN8T3B0aW9uNHxPcHRpb241',input_top_k='3')"
            )
        )
        DceMethod.Points -> listOf(
            IntentExample(
                ...
                intentUri = "com.example.methodmesh.EXECUTE_METHOD(method_id='dce.points',input64_items='RmVhdHVyZSBBfEZlYXR1cmUgQnxGZWF0dXJlIEN8RmVhdHVyZSBE',input_points='100')"
            ),
            IntentExample(
                label = "Custom points budget",
                description = "Allocate custom number of points",
                intentUri = "com.example.methodmesh.EXECUTE_METHOD(method_id='dce.points',input64_options='QXR0cjF8QXR0cjJ8QXR0cjM',input_points='50')"
            )
        )
        DceMethod.Conjoint -> listOf(
            IntentExample(
                ...
                intentUri = "com.example.methodmesh.EXECUTE_METHOD(method_id='dce.conjoint',input_rounds='3',input64_classes='QlJBTkQ6UGFuYXNvbmljLFNvbnksTmludGVuZG98RkVBVFVSRTpCYXNpYyxQcmVtaXVtfFBSSUNFOkxvdyxNZWRpdW0sSGlnaA',input_profiles_per_round='2')"
            ),
            IntentExample(
                label = "With predefined attributes",
                description = "Conjoint with specific attributes",
                intentUri = "com.example.methodmesh.EXECUTE_METHOD(method_id='dce.conjoint',input_rounds='5',input64_classes='QlJBTkQ6UGFuYXNvbmljLFNvbnl8RkVBVFVSRTpCYXNpYyxQcmVtaXVtfFBSSUNFOjEwMCwxNTAsMjAw',input_profiles_per_round='2',input_seed='study_001')"
            )
        )
    }
}
