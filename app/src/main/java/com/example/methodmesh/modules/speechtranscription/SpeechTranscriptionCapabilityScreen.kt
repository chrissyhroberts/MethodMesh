    ...
    override fun Render(
        ...
        CapabilityScreenScaffold(
            ...
            IntentExampleDropdown(
                capabilityId = capabilityId,
                examples = listOf(
                    IntentExample("Speech to text", "Open speech capture and return the transcript.", "com.example.methodmesh.EXECUTE_METHOD(method_id='speech.transcribe',input_speech_language='en-GB',input_speech_prompt='Please speak now',input_speech_prefer_offline='true',return_mode='flat')")
                )
            )
        }
    }
