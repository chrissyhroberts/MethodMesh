...
import com.example.methodmesh.transport.LaunchConfigParser
...
object AndroidIntentRequestReader {
     ...
     * to overwrite URI parameters, causes MethodMesh to fall back to dashboard demo
     ...
     *
     * com.example.methodmesh.EXECUTE_METHOD(method_id='module.method',policy='required')
     *
