...
```text
com.example.researchos.EXECUTE_METHOD(method_id='gps_target_navigator',input_target_name='Clinic',input_target_latitude='-1.28',input_target_longitude='36.81',input_arrival_radius_m='50',input_show_ar_camera='true')
```
