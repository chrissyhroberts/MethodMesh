...
object ProviderCommandRegistry {
    private const val PREFS = "researchos_provider_command_registry"
    ...
    fun exportBundle(context: Context, onlyCommandId: String? = null): String {
        ...
        val payload = JSONObject().apply {
            put("researchos_provider_command_registry_version", VERSION)
    ...
    fun builtInCommands(): List<ProviderCommand> = listOf(
        ...
        ProviderCommand(
            ...
            defaultValues = linkedMapOf(
                "phone" to "+441234567890",
                "message" to "Hello from ResearchOS"
            )
        ),
        ProviderCommand(
            ...
            defaultValues = linkedMapOf(
                ...
                "subject" to "ResearchOS message",
                "body" to "Hello from ResearchOS"
            )
        ),
        ProviderCommand(
            ...
            defaultValues = linkedMapOf(
                "subject" to "ResearchOS",
                "text" to "Shared from ResearchOS"
            )
        ),
        ProviderCommand(
