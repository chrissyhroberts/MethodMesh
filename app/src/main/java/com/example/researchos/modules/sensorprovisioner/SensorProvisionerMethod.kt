...
object As100SensorProvisionerMethod : As100Method {
    ...
    override val id = ID
    override val ref = ArchitectureRef(ArchitectureId(ID), "Method", "Provision ResearchOS BLE sensor node")
    override val descriptor = MethodDescriptor(
        id = ArchitectureId(ID),
        methodType = MethodObjectType.Workflow,
        name = "Provision BLE sensor node",
        version = VERSION,
        description = "Configure a ResearchOS BLE environmental sensor node and save it into the device registry.",
