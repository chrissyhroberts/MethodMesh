...
```text
com.example.researchos.EXECUTE_METHOD(method_id='mlkit.vision.analyze',input_mlkit_mode='ocr_and_barcodes',input_source='camera',return_mode='flat')
```
...
in the normal ResearchOS export/ODK attachment handling.
