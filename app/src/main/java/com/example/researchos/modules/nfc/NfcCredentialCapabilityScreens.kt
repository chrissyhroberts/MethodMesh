        ...
        fun beginPreparedWrite() {
            when {
                ...
                pin != confirmPin -> status = "The PIN entries do not match."
                    ...
                    delay(150)
                    active = true
                    status = "Tap the same card again and hold it in place while ResearchOS writes and verifies it."
                }
            }
        }
            ...
            IntentExampleDropdown(
                ...
                examples = listOf(
                    IntentExample(
                        ...
                        description = "The PIN is entered only inside ResearchOS and is never returned to ODK.",
                        intentUri = "com.example.researchos.EXECUTE_METHOD(method_id='$capabilityId',input_credential_subject_id='operator_001',input_pin_length='6',input_overwrite_policy='empty_only')"
                    )
                )
            )
        }
        ...
        NfcDeviceServiceEffect(
            ...
            onSignal = { signal ->
                ...
                if (candidate == null) {
                    ...
                    status = "The tag contains $recordCount NDEF record(s), but none is a supported ResearchOS portable credential (record type: $recordTypes)."
            ...
            IntentExampleDropdown(
                ...
                examples = listOf(
                    IntentExample(
                        ...
                        description = "Scan the card, then enter its PIN inside ResearchOS.",
                        intentUri = "com.example.researchos.EXECUTE_METHOD(method_id='$capabilityId',return_mode='flat')"
                    )
                )
            )
        }
