...
object As100SensorReadMethod : As100Method {
    ...
    override val id = ID
    override val ref = ArchitectureRef(ArchitectureId(ID), "Method", "Read a ResearchOS sensor")
    override val descriptor = MethodDescriptor(
        id = ArchitectureId(ID),
        methodType = MethodObjectType.Method,
        name = "Read sensor",
        version = VERSION,
        description = "Connect to a registered or nearby ResearchOS sensor and return single, trace, or averaged measurements.",
