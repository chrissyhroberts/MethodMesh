...
All methods use the standard ResearchOS execution boundary:

```text
com.example.researchos.EXECUTE_METHOD(method_id='tree_height_measurement',input_horizontal_distance_m=12.5,input_observer_height_m=1.65,input_base_angle_deg=-2.0,input_top_angle_deg=31.4,return_mode='flat')
```
