...
import com.example.researchos.platform.externalforms.ExternalForm
import com.example.researchos.platform.externalforms.ExternalFormCatalog
import com.example.researchos.platform.externalforms.ExternalProject
...
object SchedulerCapabilityScreen : CapabilityScreenSpec {
    ...
    override val description = "Schedule an ODK form, web form, or ResearchOS process."
