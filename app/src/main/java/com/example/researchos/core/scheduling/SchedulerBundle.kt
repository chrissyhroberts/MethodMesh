...
object SchedulerBundle {
    ...
    fun export(context: Context, scheduleId: String? = null): String {
        ...
        return JSONObject().apply {
            put("researchos_schedule_bundle_version", VERSION)
    ...
    fun import(context: Context, payload: String): Decoded {
        ...
        require(root.optString("researchos_schedule_bundle_version") == VERSION) { "Unsupported schedule bundle version." }
    ...
    private fun decode(o: JSONObject) = ResearchSchedule(
        ...
        notificationTitle = o.optString("notificationTitle", "ResearchOS reminder"), notificationMessage = o.optString("notificationMessage", "A scheduled task is due."), enabled = o.optBoolean("enabled", true)
