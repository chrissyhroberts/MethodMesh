...
object SchedulerNotifications {
    fun ensureChannel(context: Context) {
        if (Build.VERSION.SDK_INT >= 26) context.getSystemService(NotificationManager::class.java).createNotificationChannel(NotificationChannel(SchedulerAlarmReceiver.CHANNEL, "ResearchOS schedules", NotificationManager.IMPORTANCE_DEFAULT))
    }
}
