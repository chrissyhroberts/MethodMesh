...
private fun FullScreenCapabilityDialog(
    ...
    immersiveOverlay: @Composable () -> Unit = {},
    content: @Composable () -> Unit
) {
    Dialog(
        ...
        Surface(
            ...
            when (presentation) {
                CapabilityHostPresentation.Immersive -> {
                    ...
                    // Generic MethodMesh actions remain available as a lightweight
                    // overlay so immersive presentation never removes core lifecycle
                    // affordances such as Save as preset.
