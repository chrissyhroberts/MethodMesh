...
DESKTOP_VERIFIER_ID = "methodmesh_audit_v14_1_project_scope"
METHODMESH_AUDIT_VERSION = "14.1"
...
$("assurance-badges").innerHTML=badge("PLATFORM MONITORED","good")+badge(centralProvenance?"CENTRAL PROVENANCE":"CENTRAL AUDIT LIMITED",centralProvenance?"good":"warn")+(methodmeshVerified?badge("METHODMESH VERIFIED EVIDENCE","good"):badge("NO DEVICE-LEVEL METHODMESH ATTESTATION","info"));
...
$("overview-cards").innerHTML=[card("Overall",errors?"ATTENTION":"VERIFIED",errors?`${errors} verification error(s)`:"No verification errors"),card("Checkpoint",rfcOK?"RFC3161 VERIFIED":fmt(C.timestamp_status||C.trusted_timestamp_status)),card("Verified current",verifiedPresent),card("MethodMesh-evidenced",methodmeshCount,"Records with collection/desktop MethodMesh evidence"),card("Zero-version anomalies",zero),card("Currently deleted",deleted),card("Unresolved edit reasons",unresolved),card("Research values in bundle","NO")].join("");
