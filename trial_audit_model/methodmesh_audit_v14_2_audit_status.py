...
DESKTOP_VERIFIER_ID = "methodmesh_audit_v14_2_audit_status"
METHODMESH_AUDIT_VERSION = "14.2"
...
def create_auditor_safe_export(
    *,
    ...
    try:
        ...
        console_status(
            "Auditor export: generating self-contained static HTML dashboard..."
        )
        (staging / "index.html").write_text(
            render_static_auditor_dashboard(
...
images, CDN dependencies or calls back to ODK Central. It is generated only
from the auditor-safe evidence in this bundle.
