...
The ResearchOS Conceptual Model defines the fundamental concepts used to represent scientific research independently of implementation, programming language or storage technology.

ResearchOS is not primarily a workflow engine or data collection platform.
...
All higher-level components of ResearchOS derive from these concepts.
...
ResearchOS represents this process directly.
...
ResearchOS therefore distinguishes four fundamental concepts:
...
The ResearchOS conceptual model is organised into five layers.

## Layer 1 – Reality

Reality consists of the entities that become the subjects of research.

ResearchOS does not create these entities.
...
The central ResearchOS model is summarised below.
...
The ResearchOS Conceptual Model follows the following principles.
...
ResearchOS records the evolution of understanding rather than replacing previous knowledge.
...
- What canonical assertion vocabulary should ResearchOS define?
...
ResearchOS represents scientific understanding rather than scientific data.
