...
The Assertion Registry defines the canonical language used by ResearchOS to represent scientific understanding.
...
This registry defines the classes of Assertions recognised by ResearchOS.
...
ResearchOS therefore represents Assertions separately from both the Entities they describe and the Observations that may support them.
...
Instead, ResearchOS preserves the evolution of scientific understanding through the accumulation of timestamped Assertions.
...
Assertions participate in the ResearchOS knowledge model by describing Entities and linking scientific understanding to the Observations that may support it.
...
ResearchOS preserves this historical record.
...
Research projects may extend Assertion definitions with additional metadata or domain-specific semantics provided these extensions remain consistent with the ResearchOS conceptual model.

# 6. Canonical Assertion Types

The Assertion Registry defines a canonical vocabulary of Assertion types used to represent scientific understanding within ResearchOS.
...
The following sections define the current canonical Assertion types recognised by ResearchOS.

# 7. Relationships

Assertions occupy the central position within the ResearchOS knowledge model.
...
- Should ResearchOS define a canonical vocabulary for common scientific Assertions?
...
Together these concepts provide the knowledge layer of the ResearchOS conceptual model.
