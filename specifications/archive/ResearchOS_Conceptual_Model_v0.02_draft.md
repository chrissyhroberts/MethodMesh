# ResearchOS Conceptual Model – Design Notes v0.01
...
These notes capture the emerging conceptual model behind ResearchOS.

Unlike the Architecture Standard, the ResearchOS Intent Language and the JSON Object Model, this document is intentionally exploratory. Its purpose is to record the design thinking that will eventually inform future architectural specifications.

The central question is simple:

> **What kinds of things exist within ResearchOS?**

Earlier versions of ResearchOS focused primarily on execution. Methods, Invocations, Policies and Signals were treated as the core architectural concepts.

The current direction suggests a different perspective.

ResearchOS should not simply execute research activities. It should represent the research world itself.
...
The current hypothesis is that every object represented by ResearchOS becomes a **Research Object**.
...
Research Objects become the fundamental nodes of the ResearchOS graph.
...
The current hypothesis is that every object managed by ResearchOS is represented as a **Research Object**.
...
ResearchOS therefore favours composition over inheritance.
...
Instead, ResearchOS aims to describe a wide variety of research domains using a small and stable conceptual vocabulary.
...
Status allows ResearchOS to represent future activities, historical events and simulated scenarios using the same conceptual framework as real-world observations.
...
This allows ResearchOS to support graph traversal, dependency analysis, provenance tracing and visualisation.
...
Current thinking suggests that Observation may become a fundamental Kind within the ResearchOS conceptual model.
...
The emerging architecture suggests that ResearchOS maintains a graph representing the research ecosystem.
...
Unlike a traditional workflow engine, ResearchOS does not simply execute a sequence of operations.
...
# 14. Implications for ResearchOS

The emerging conceptual model has significant implications for the future architecture of ResearchOS.
...
Current thinking suggests that ResearchOS is fundamentally a graph of Research Objects.
...
- ResearchOS Architecture Standard v1.02;
- ResearchOS Conceptual Model specification;
...
Once the primitive concepts have been agreed, they should be incorporated into the Architecture Standard and formalised within a dedicated ResearchOS Conceptual Model specification.

# X. The Assertion Model

The ResearchOS Conceptual Model represents research knowledge as a collection of timestamped assertions.

An assertion is a statement made about one or more Research Entities.
...
Participant 001 is_member_of Household 001

Blood Sample 123 collected_from Participant 001

Observation 456 about Blood Sample 123

Protocol A defines Visit 2

Method PCR produced Observation 456

ResearchOS therefore does not distinguish between study structure, metadata, observations and analytical outputs as separate conceptual models.

Instead, they are all represented as assertions with associated provenance.

Knowledge accumulates through the addition of new assertions rather than modification of existing knowledge.

This naturally supports temporal reasoning, provenance, reproducibility and graph-based navigation.

The Research Object Graph is one representation of this collection of assertions.

The underlying conceptual model is the evolving body of assertions made about Research Entities.

## New Axioms?

1. ResearchOS models the research world, not just research execution.
2. Entities exist in Physical, Digital and Conceptual modes.
3. Knowledge is represented as assertions about entities.
4. Methods create assertions; observations support assertions; provenance explains assertions.
