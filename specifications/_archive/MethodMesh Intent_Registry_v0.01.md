# MethodMesh Intent Registry v0.01

**Status:** Draft

The MethodMesh Intent Registry defines the canonical vocabulary of `intent` values used by MethodMesh Execution Requests.
...
The Intent Registry provides a controlled vocabulary for MethodMesh Invocations.

It is used by:

- the Research Intent Language;
- the MethodMesh JSON Object Model;
- Method manifests;
- Method registries;
- transport bindings;
- SDKs;
...
Every MethodMesh Invocation SHOULD use an Intent defined by this registry or by a recognised extension registry.
...
The Intent Registry forms part of the MethodMesh specification family.

| Specification | Responsibility |
|---------------|----------------|
| Architecture Standard | Runtime concepts and execution model |
| Research Intent Language | Human-readable semantics |
| MethodMesh JSON Object Model | Canonical machine-readable object model |
...
Knowledge Acquisition Intents change what MethodMesh knows by obtaining new information.
...
System Intents interrogate or administer the MethodMesh runtime.
...
| `import` | Bring external Resources into MethodMesh. | file, dataset, protocol, configuration | Used for inbound transfer. |
| `export` | Transfer Resources out of MethodMesh. | file, dataset, report, provenance | Used for outbound extraction. |
...
The excluded terms are not invalid in extension registries, but they SHOULD NOT be used in core MethodMesh specifications.
...
In the MethodMesh JSON Object Model, the Intent is represented using the `intent` property of an Invocation Object.
...
Intent Registry versions are independent of MethodMesh runtime versions.
...
| Version | Summary |
|---------|---------|
| v0.01 | Initial MethodMesh Intent Registry derived from RIL Core Verbs v0.01. |
