...
ResearchOS is founded on the principle that scientific research is fundamentally concerned with understanding the world through evidence.

Rather than modelling research as a collection of software workflows or datasets, ResearchOS models the process by which scientific understanding is created, refined and preserved.
...
ResearchOS represents those entities rather than creating them.
...
ResearchOS records the evolution of scientific understanding.
...
ResearchOS is not intended simply to execute research.
...
By separating entities, assertions and observations, ResearchOS provides a common conceptual language capable of supporting laboratory science, epidemiology, social science, environmental research, engineering and future disciplines that have yet to emerge.
